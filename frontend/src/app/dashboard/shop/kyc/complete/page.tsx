              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className={`px-2 py-1 text-xs rounded ${
                    connectStatus.accountId ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                  }`}>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className={`px-2 py-1 text-xs rounded ${
                    connectStatus.chargesEnabled ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                  }`}>
                ...
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className={`px-2 py-1 text-xs rounded ${
                    connectStatus.payoutsEnabled ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                  }`}>
