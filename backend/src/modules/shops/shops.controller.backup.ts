...
export class ShopsController {
  ...
  @Get(':id/products')
  @ApiOperation({ summary: 'Get all products for a shop by ID' })
  @ApiParam({ name: 'id', description: 'Shop ID' })
  @ApiResponse({ status: 200, description: 'Shop products retrieved successfully' })
  @ApiResponse({ status: 404, description: 'Shop not found' })
  findProductsById(@Param('id', ParseUUIDPipe) id: string) {
    // For now, redirect to the products controller route
