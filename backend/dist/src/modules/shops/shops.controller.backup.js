...
let ShopsController = class ShopsController {
    constructor(shopsService, productsService, paymentsService) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get all products for a shop by ID' }),
...
//# sourceMappingURL=shops.controller.backup.js.map