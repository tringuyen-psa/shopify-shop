...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Payment amount', example: 29.99 }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Stripe customer ID', example: 'cus_123456' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreatePaymentIntentDto.prototype, "customerId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Metadata for the payment intent', example: { orderId: 'order_123' } }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Object)
], CreatePaymentIntentDto.prototype, "metadata", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ description: 'Payment method ID for immediate confirmation' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
