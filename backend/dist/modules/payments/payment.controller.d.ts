...
export declare class PaymentsController {
    ...
    confirmPaymentIntent(intentId: string): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.PaymentIntent>;
    }>;
    cancelPaymentIntent(intentId: string): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.PaymentIntent>;
    }>;
    createSetupIntent(createSetupIntentDto: CreateSetupIntentDto): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.SetupIntent>;
    }>;
    getCustomerPaymentMethods(customerId: string): Promise<{
        success: boolean;
        data: import("stripe").Stripe.PaymentMethod[];
    }>;
    detachPaymentMethod(paymentMethodId: string): Promise<{
        success: boolean;
        message: string;
    }>;
    createRefund(refundPaymentDto: RefundPaymentDto): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.Refund>;
    }>;
    getRefund(refundId: string): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.Refund>;
    }>;
    createConnectAccount(body: {
        shopId: string;
        userId: string;
    }): Promise<{
        success: boolean;
    ...
    createOnboardingLink(accountId: string): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.AccountLink>;
    }>;
    createDashboardLink(accountId: string): Promise<{
        success: boolean;
    ...
    getAccountBalance(accountId: string): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.Balance>;
    }>;
    createPayout(accountId: string, body: {
        amount: number;
        currency?: string;
    }): Promise<{
        success: boolean;
        data: import("stripe").Stripe.Response<import("stripe").Stripe.Payout>;
    }>;
    getAllTransactions(page?: number, limit?: number, shopId?: string): Promise<{
        success: boolean;
        data: {
            transactions: import("stripe").Stripe.PaymentIntent[];
            hasMore: boolean;
        };
    }>;
