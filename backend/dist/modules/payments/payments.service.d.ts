...
export declare class PaymentsService {
    ...
    createConnectAccount(shopId: string, userId: string): Promise<Stripe.Response<Stripe.Account>>;
    ...
    createDashboardLink(accountId: string): Promise<Stripe.Response<Stripe.LoginLink>>;
