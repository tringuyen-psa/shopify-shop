...
const shops_service_1 = require("../src/modules/shops/shops.service");
...
async function seedProducts() {
    ...
    try {
        const shopsService = app.get(shops_service_1.ShopsService);
        const productsService = app.get(products_service_1.ProductsService);
        console.log('📋 Fetching existing shops...');
        const shopsResponse = await shopsService.findAll({ limit: 100 });
